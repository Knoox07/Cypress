...
it.only('Click link Moved', () => {
  cy.viewport(1920, 1080)
  cy.visit('https://demoqa.com')
  cy.contains('Elements').click()
  cy.contains('Links').click()
  cy.get('[id="moved"]').click()
  cy.get('[id="linkResponse"]').should('be.visible', 'Link has responded with staus 301 and status text Moved Permanently')
  })
