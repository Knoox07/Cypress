...
it.only('Click link No Content', () => {
  cy.viewport(1920, 1080)
  cy.visit('https://demoqa.com')
  cy.contains('Elements').click()
  cy.contains('Links').click()
  cy.get('[id="no-content"]').click()
  cy.get('[id="linkResponse"]').should('be.visible', 'Link has responded with staus 204 and status text No Content')
  })
